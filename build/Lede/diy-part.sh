...
# 后台IP设置
export Ipv4_ipaddr="10.88.88.1"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="shadowXrouter"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export Customized_Information="XiaoX$(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
